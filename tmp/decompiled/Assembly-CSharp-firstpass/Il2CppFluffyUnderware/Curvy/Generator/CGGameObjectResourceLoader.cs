...
public class CGGameObjectResourceLoader : Il2CppSystem.Object
{
	...
	static CGGameObjectResourceLoader()
	{
		Il2CppClassPointerStore<CGGameObjectResourceLoader>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp-firstpass.dll", "FluffyUnderware.Curvy.Generator", "CGGameObjectResourceLoader");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CGGameObjectResourceLoader>.NativeClassPtr);
		NativeMethodInfoPtr_InitializeOnLoad_Protected_Static_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CGGameObjectResourceLoader>.NativeClassPtr, 100665839);
		NativeMethodInfoPtr_Create_Public_Virtual_Final_New_Component_CGModule_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CGGameObjectResourceLoader>.NativeClassPtr, 100665840);
		NativeMethodInfoPtr_Destroy_Public_Virtual_Final_New_Void_CGModule_Component_String_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CGGameObjectResourceLoader>.NativeClassPtr, 100665841);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CGGameObjectResourceLoader>.NativeClassPtr, 100665842);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 47219, XrefRangeEnd = 47229, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 47229, XrefRangeEnd = 47237, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 47237, XrefRangeEnd = 47248, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe CGGameObjectResourceLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CGGameObjectResourceLoader>.NativeClassPtr))
	{
		System.IntPtr* ptr = null;
		Unsafe.SkipInit(out System.IntPtr intPtr2);
	...
	public CGGameObjectResourceLoader(System.IntPtr pointer)
		: base(pointer)
	{
	}
}

...
[ObfuscatedName("<>f__AnonymousType0`4")]
public sealed class __f__AnonymousType0<_A_j__TPar, _B_j__TPar, _C_j__TPar, _D_j__TPar> : Il2CppSystem.Object
{
	...
	private static readonly System.IntPtr NativeMethodInfoPtr__ctor_Public_Void__A_j__TPar__B_j__TPar__C_j__TPar__D_j__TPar_0;
	...
	{
		Il2CppClassPointerStore<__f__AnonymousType0<_A_j__TPar, _B_j__TPar, _C_j__TPar, _D_j__TPar>>.NativeClassPtr = IL2CPP.il2cpp_class_from_type(Il2CppSystem.Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(IL2CPP.GetIl2CppClass("Assembly-CSharp-firstpass.dll", "", "<>f__AnonymousType0`4"))).MakeGenericType(new Il2CppReferenceArray<Il2CppSystem.Type>(new Il2CppSystem.Type[4]
		{
		...
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<__f__AnonymousType0<_A_j__TPar, _B_j__TPar, _C_j__TPar, _D_j__TPar>>.NativeClassPtr);
		NativeFieldInfoPtr__A_i__Field = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<__f__AnonymousType0<_A_j__TPar, _B_j__TPar, _C_j__TPar, _D_j__TPar>>.NativeClassPtr, "<A>i__Field");
		NativeFieldInfoPtr__B_i__Field = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<__f__AnonymousType0<_A_j__TPar, _B_j__TPar, _C_j__TPar, _D_j__TPar>>.NativeClassPtr, "<B>i__Field");
		NativeFieldInfoPtr__C_i__Field = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<__f__AnonymousType0<_A_j__TPar, _B_j__TPar, _C_j__TPar, _D_j__TPar>>.NativeClassPtr, "<C>i__Field");
		NativeFieldInfoPtr__D_i__Field = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<__f__AnonymousType0<_A_j__TPar, _B_j__TPar, _C_j__TPar, _D_j__TPar>>.NativeClassPtr, "<D>i__Field");
		NativeMethodInfoPtr_get_A_Public_get__A_j__TPar_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<__f__AnonymousType0<_A_j__TPar, _B_j__TPar, _C_j__TPar, _D_j__TPar>>.NativeClassPtr, 100663297);
		NativeMethodInfoPtr_get_B_Public_get__B_j__TPar_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<__f__AnonymousType0<_A_j__TPar, _B_j__TPar, _C_j__TPar, _D_j__TPar>>.NativeClassPtr, 100663298);
		NativeMethodInfoPtr_get_C_Public_get__C_j__TPar_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<__f__AnonymousType0<_A_j__TPar, _B_j__TPar, _C_j__TPar, _D_j__TPar>>.NativeClassPtr, 100663299);
		NativeMethodInfoPtr_get_D_Public_get__D_j__TPar_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<__f__AnonymousType0<_A_j__TPar, _B_j__TPar, _C_j__TPar, _D_j__TPar>>.NativeClassPtr, 100663300);
		NativeMethodInfoPtr__ctor_Public_Void__A_j__TPar__B_j__TPar__C_j__TPar__D_j__TPar_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<__f__AnonymousType0<_A_j__TPar, _B_j__TPar, _C_j__TPar, _D_j__TPar>>.NativeClassPtr, 100663301);
		NativeMethodInfoPtr_Equals_Public_Virtual_Boolean_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<__f__AnonymousType0<_A_j__TPar, _B_j__TPar, _C_j__TPar, _D_j__TPar>>.NativeClassPtr, 100663302);
		NativeMethodInfoPtr_GetHashCode_Public_Virtual_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<__f__AnonymousType0<_A_j__TPar, _B_j__TPar, _C_j__TPar, _D_j__TPar>>.NativeClassPtr, 100663303);
		NativeMethodInfoPtr_ToString_Public_Virtual_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<__f__AnonymousType0<_A_j__TPar, _B_j__TPar, _C_j__TPar, _D_j__TPar>>.NativeClassPtr, 100663304);
	}

	[CallerCount(2)]
	[CachedScanResults(RefRangeStart = 3857, RefRangeEnd = 3859, XrefRangeStart = 3856, XrefRangeEnd = 3857, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe __f__AnonymousType0(_A_j__TPar A, _B_j__TPar B, _C_j__TPar C, _D_j__TPar D)
	{
		...
		this._002Ector(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<__f__AnonymousType0<_A_j__TPar, _B_j__TPar, _C_j__TPar, _D_j__TPar>>.NativeClassPtr));
		...
		*(void**)num3 = Unsafe.AsPointer(ref reference4);
		...
		System.IntPtr intPtr5 = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void__A_j__TPar__B_j__TPar__C_j__TPar__D_j__TPar_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr6);
		Il2CppException.RaiseExceptionIfNecessary(intPtr6);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 3859, XrefRangeEnd = 3860, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 3860, XrefRangeEnd = 3864, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 3864, XrefRangeEnd = 3891, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]

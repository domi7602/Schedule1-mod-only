...
public class CanvasSampleSaveFileImage : MonoBehaviour
{
	...
	public unsafe Text output
	{
		...
		set
		{
			...
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_output)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)text));
		}
	}
	...
	public unsafe Il2CppStructArray<byte> _textureBytes
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr__textureBytes);
			IntPtr intPtr = *(IntPtr*)num;
		...
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr__textureBytes)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)val));
		}
	}
	...
	static CanvasSampleSaveFileImage()
	{
		...
		NativeFieldInfoPtr_output = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CanvasSampleSaveFileImage>.NativeClassPtr, "output");
		NativeFieldInfoPtr__textureBytes = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CanvasSampleSaveFileImage>.NativeClassPtr, "_textureBytes");
		NativeMethodInfoPtr_Awake_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CanvasSampleSaveFileImage>.NativeClassPtr, 100663543);
		NativeMethodInfoPtr_OnPointerDown_Public_Virtual_Final_New_Void_PointerEventData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CanvasSampleSaveFileImage>.NativeClassPtr, 100663544);
		NativeMethodInfoPtr_Start_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CanvasSampleSaveFileImage>.NativeClassPtr, 100663545);
		NativeMethodInfoPtr_OnClick_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CanvasSampleSaveFileImage>.NativeClassPtr, 100663546);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CanvasSampleSaveFileImage>.NativeClassPtr, 100663547);
	}
	...
	public unsafe CanvasSampleSaveFileImage()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CanvasSampleSaveFileImage>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public CanvasSampleSaveFileImage(IntPtr pointer)
		: base(pointer)
	{
	}
}

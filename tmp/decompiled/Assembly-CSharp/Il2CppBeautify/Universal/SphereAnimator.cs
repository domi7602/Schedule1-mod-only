...
public class SphereAnimator : MonoBehaviour
{
	...
	static SphereAnimator()
	{
		...
		NativeFieldInfoPtr_rb = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SphereAnimator>.NativeClassPtr, "rb");
		NativeMethodInfoPtr_Start_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SphereAnimator>.NativeClassPtr, 100664819);
		NativeMethodInfoPtr_FixedUpdate_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SphereAnimator>.NativeClassPtr, 100664820);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SphereAnimator>.NativeClassPtr, 100664821);
	}
	...
	public unsafe SphereAnimator()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<SphereAnimator>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public SphereAnimator(IntPtr pointer)
		: base(pointer)
	{
	}
}

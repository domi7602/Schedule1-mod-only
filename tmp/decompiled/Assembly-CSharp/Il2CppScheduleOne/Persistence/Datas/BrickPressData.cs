...
public class BrickPressData : GridItemData
{
	...
	static BrickPressData()
	{
		...
		NativeFieldInfoPtr_Contents = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<BrickPressData>.NativeClassPtr, "Contents");
		NativeMethodInfoPtr__ctor_Public_Void_Guid_ItemInstance_Int32_Grid_Vector2_Int32_ItemSet_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BrickPressData>.NativeClassPtr, 100669419);
	}
	...
	public unsafe BrickPressData(Il2CppSystem.Guid guid, ItemInstance item, int loadOrder, Grid grid, Vector2 originCoordinate, int rotation, ItemSet contents)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<BrickPressData>.NativeClassPtr))
	{
	...
	public BrickPressData(System.IntPtr pointer)
		: base(pointer)
	{
	}
}

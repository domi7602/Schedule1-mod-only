...
public class StationRecipeFieldData : Il2CppSystem.Object
{
	...
	static StationRecipeFieldData()
	{
		...
		NativeFieldInfoPtr_RecipeID = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<StationRecipeFieldData>.NativeClassPtr, "RecipeID");
		NativeMethodInfoPtr__ctor_Public_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<StationRecipeFieldData>.NativeClassPtr, 100669400);
	}
	...
	public unsafe StationRecipeFieldData(string recipeID)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<StationRecipeFieldData>.NativeClassPtr))
	{
	...
	public StationRecipeFieldData(System.IntPtr pointer)
		: base(pointer)
	{
	}
}

...
public class PackagingStationData : GridItemData
{
	...
	static PackagingStationData()
	{
		...
		NativeFieldInfoPtr_Contents = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PackagingStationData>.NativeClassPtr, "Contents");
		NativeMethodInfoPtr__ctor_Public_Void_Guid_ItemInstance_Int32_Grid_Vector2_Int32_ItemSet_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PackagingStationData>.NativeClassPtr, 100669432);
	}
	...
	public unsafe PackagingStationData(Il2CppSystem.Guid guid, ItemInstance item, int loadOrder, Grid grid, Vector2 originCoordinate, int rotation, ItemSet contents)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PackagingStationData>.NativeClassPtr))
	{
	...
	public PackagingStationData(System.IntPtr pointer)
		: base(pointer)
	{
	}
}

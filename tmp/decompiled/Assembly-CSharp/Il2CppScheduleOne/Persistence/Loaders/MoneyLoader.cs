...
public class MoneyLoader : Loader
{
	...
	static MoneyLoader()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MoneyLoader>.NativeClassPtr, 100669027);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MoneyLoader>.NativeClassPtr, 100669028);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe MoneyLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<MoneyLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public MoneyLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

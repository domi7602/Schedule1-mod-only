...
public class MethProductLoader : Loader
{
	...
	static MethProductLoader()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MethProductLoader>.NativeClassPtr, 100669025);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MethProductLoader>.NativeClassPtr, 100669026);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe MethProductLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<MethProductLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public MethProductLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

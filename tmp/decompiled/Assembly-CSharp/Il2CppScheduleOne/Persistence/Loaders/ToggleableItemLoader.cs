...
public class ToggleableItemLoader : GridItemLoader
{
	...
	static ToggleableItemLoader()
	{
		...
		NativeMethodInfoPtr_get_ItemType_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ToggleableItemLoader>.NativeClassPtr, 100669288);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ToggleableItemLoader>.NativeClassPtr, 100669289);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ToggleableItemLoader>.NativeClassPtr, 100669290);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_DynamicSaveData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ToggleableItemLoader>.NativeClassPtr, 100669291);
	}
	...
	public unsafe ToggleableItemLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ToggleableItemLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public ToggleableItemLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

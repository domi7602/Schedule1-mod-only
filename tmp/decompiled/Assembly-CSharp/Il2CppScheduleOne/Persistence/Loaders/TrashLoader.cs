...
public class TrashLoader : Loader
{
	...
	static TrashLoader()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TrashLoader>.NativeClassPtr, 100669079);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TrashLoader>.NativeClassPtr, 100669080);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe TrashLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<TrashLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public TrashLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

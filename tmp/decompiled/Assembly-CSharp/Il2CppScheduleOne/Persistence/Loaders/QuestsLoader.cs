...
public class QuestsLoader : Loader
{
	...
	static QuestsLoader()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QuestsLoader>.NativeClassPtr, 100669059);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QuestsLoader>.NativeClassPtr, 100669060);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe QuestsLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<QuestsLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public QuestsLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

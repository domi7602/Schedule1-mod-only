...
public class ToggleableSurfaceItemLoader : SurfaceItemLoader
{
	...
	static ToggleableSurfaceItemLoader()
	{
		...
		NativeMethodInfoPtr_get_ItemType_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ToggleableSurfaceItemLoader>.NativeClassPtr, 100669292);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ToggleableSurfaceItemLoader>.NativeClassPtr, 100669293);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ToggleableSurfaceItemLoader>.NativeClassPtr, 100669294);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_DynamicSaveData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ToggleableSurfaceItemLoader>.NativeClassPtr, 100669295);
	}
	...
	public unsafe ToggleableSurfaceItemLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ToggleableSurfaceItemLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public ToggleableSurfaceItemLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

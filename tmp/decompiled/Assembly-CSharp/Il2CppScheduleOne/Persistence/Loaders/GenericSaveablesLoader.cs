...
public class GenericSaveablesLoader : Loader
{
	...
	static GenericSaveablesLoader()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GenericSaveablesLoader>.NativeClassPtr, 100669008);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GenericSaveablesLoader>.NativeClassPtr, 100669009);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe GenericSaveablesLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<GenericSaveablesLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public GenericSaveablesLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

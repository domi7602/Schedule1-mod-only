...
public class VariablesLoader : Loader
{
	...
	static VariablesLoader()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VariablesLoader>.NativeClassPtr, 100669081);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VariablesLoader>.NativeClassPtr, 100669082);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe VariablesLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<VariablesLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public VariablesLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

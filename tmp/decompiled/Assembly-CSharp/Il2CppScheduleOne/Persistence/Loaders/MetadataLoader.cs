...
public class MetadataLoader : Loader
{
	...
	static MetadataLoader()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MetadataLoader>.NativeClassPtr, 100669023);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MetadataLoader>.NativeClassPtr, 100669024);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe MetadataLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<MetadataLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public MetadataLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

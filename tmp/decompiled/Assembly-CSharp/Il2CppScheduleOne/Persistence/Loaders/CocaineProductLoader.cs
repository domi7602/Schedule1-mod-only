...
public class CocaineProductLoader : Loader
{
	...
	static CocaineProductLoader()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CocaineProductLoader>.NativeClassPtr, 100668996);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CocaineProductLoader>.NativeClassPtr, 100668997);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe CocaineProductLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CocaineProductLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public CocaineProductLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

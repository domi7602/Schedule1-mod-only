...
public class TrashGrabberLoader : ItemLoader
{
	...
	static TrashGrabberLoader()
	{
		...
		NativeMethodInfoPtr_get_ItemType_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TrashGrabberLoader>.NativeClassPtr, 100669516);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TrashGrabberLoader>.NativeClassPtr, 100669517);
		NativeMethodInfoPtr_LoadItem_Public_Virtual_ItemInstance_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TrashGrabberLoader>.NativeClassPtr, 100669518);
	}
	...
	public unsafe TrashGrabberLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<TrashGrabberLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public TrashGrabberLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

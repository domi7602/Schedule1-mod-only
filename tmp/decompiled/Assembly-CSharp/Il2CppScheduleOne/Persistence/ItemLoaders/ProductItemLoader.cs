...
public class ProductItemLoader : ItemLoader
{
	...
	{
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 135803, XrefRangeEnd = 135810, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		get
		{
	...
	static ProductItemLoader()
	{
		...
		NativeMethodInfoPtr_get_ItemType_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ProductItemLoader>.NativeClassPtr, 100669507);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ProductItemLoader>.NativeClassPtr, 100669508);
		NativeMethodInfoPtr_LoadItem_Public_Virtual_ItemInstance_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ProductItemLoader>.NativeClassPtr, 100669509);
	}
	...
	public unsafe ProductItemLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ProductItemLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 135810, XrefRangeEnd = 135843, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public ProductItemLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

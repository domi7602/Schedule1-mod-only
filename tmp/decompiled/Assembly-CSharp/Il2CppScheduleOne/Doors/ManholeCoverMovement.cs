...
public class ManholeCoverMovement : MonoBehaviour
{
	...
	static ManholeCoverMovement()
	{
		...
		NativeFieldInfoPtr_Anim = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ManholeCoverMovement>.NativeClassPtr, "Anim");
		NativeMethodInfoPtr_Open_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ManholeCoverMovement>.NativeClassPtr, 100674500);
		NativeMethodInfoPtr_Close_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ManholeCoverMovement>.NativeClassPtr, 100674501);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ManholeCoverMovement>.NativeClassPtr, 100674502);
	}
	...
	public unsafe ManholeCoverMovement()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ManholeCoverMovement>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public ManholeCoverMovement(IntPtr pointer)
		: base(pointer)
	{
	}
}

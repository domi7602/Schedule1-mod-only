...
public class SpawnStationConfigPanel : ConfigPanel
{
	...
	static SpawnStationConfigPanel()
	{
		...
		NativeFieldInfoPtr_DestinationUI = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SpawnStationConfigPanel>.NativeClassPtr, "DestinationUI");
		NativeMethodInfoPtr_BindInternal_Protected_Virtual_Void_List_1_EntityConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SpawnStationConfigPanel>.NativeClassPtr, 100688657);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SpawnStationConfigPanel>.NativeClassPtr, 100688658);
	}
	...
	public unsafe SpawnStationConfigPanel()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<SpawnStationConfigPanel>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public SpawnStationConfigPanel(IntPtr pointer)
		: base(pointer)
	{
	}
}

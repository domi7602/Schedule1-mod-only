...
public class BrickPressConfigPanel : ConfigPanel
{
	...
	static BrickPressConfigPanel()
	{
		...
		NativeFieldInfoPtr_DestinationUI = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<BrickPressConfigPanel>.NativeClassPtr, "DestinationUI");
		NativeMethodInfoPtr_BindInternal_Protected_Virtual_Void_List_1_EntityConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BrickPressConfigPanel>.NativeClassPtr, 100688633);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BrickPressConfigPanel>.NativeClassPtr, 100688634);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 322851, XrefRangeEnd = 322886, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe BrickPressConfigPanel()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<BrickPressConfigPanel>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public BrickPressConfigPanel(IntPtr pointer)
		: base(pointer)
	{
	}
}

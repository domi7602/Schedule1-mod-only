...
public class CleanerConfigPanel : ConfigPanel
{
	...
	public unsafe ObjectListFieldUI BinsUI
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_BinsUI);
			IntPtr intPtr = *(IntPtr*)num;
		...
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_BinsUI)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)objectListFieldUI));
		}
	}
	...
	static CleanerConfigPanel()
	{
		...
		NativeFieldInfoPtr_BedUI = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CleanerConfigPanel>.NativeClassPtr, "BedUI");
		NativeFieldInfoPtr_BinsUI = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CleanerConfigPanel>.NativeClassPtr, "BinsUI");
		NativeMethodInfoPtr_BindInternal_Protected_Virtual_Void_List_1_EntityConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CleanerConfigPanel>.NativeClassPtr, 100688641);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CleanerConfigPanel>.NativeClassPtr, 100688642);
	}
	...
	public unsafe CleanerConfigPanel()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CleanerConfigPanel>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public CleanerConfigPanel(IntPtr pointer)
		: base(pointer)
	{
	}
}

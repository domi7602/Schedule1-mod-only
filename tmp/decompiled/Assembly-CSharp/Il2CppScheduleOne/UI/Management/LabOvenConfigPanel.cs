...
public class LabOvenConfigPanel : ConfigPanel
{
	...
	static LabOvenConfigPanel()
	{
		...
		NativeFieldInfoPtr_DestinationUI = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<LabOvenConfigPanel>.NativeClassPtr, "DestinationUI");
		NativeMethodInfoPtr_BindInternal_Protected_Virtual_Void_List_1_EntityConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LabOvenConfigPanel>.NativeClassPtr, 100688645);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LabOvenConfigPanel>.NativeClassPtr, 100688646);
	}
	...
	public unsafe LabOvenConfigPanel()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<LabOvenConfigPanel>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public LabOvenConfigPanel(IntPtr pointer)
		: base(pointer)
	{
	}
}

...
public class ChemistryStationConfigPanel : ConfigPanel
{
	...
	public unsafe StationRecipeFieldUI RecipeUI
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_RecipeUI);
			IntPtr intPtr = *(IntPtr*)num;
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<StationRecipeFieldUI>(intPtr) : null;
		}
		set
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_RecipeUI)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)stationRecipeFieldUI));
		}
	}
	...
	static ChemistryStationConfigPanel()
	{
		...
		NativeFieldInfoPtr_RecipeUI = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ChemistryStationConfigPanel>.NativeClassPtr, "RecipeUI");
		NativeFieldInfoPtr_DestinationUI = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ChemistryStationConfigPanel>.NativeClassPtr, "DestinationUI");
		NativeMethodInfoPtr_BindInternal_Protected_Virtual_Void_List_1_EntityConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ChemistryStationConfigPanel>.NativeClassPtr, 100688639);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ChemistryStationConfigPanel>.NativeClassPtr, 100688640);
	}
	...
	public unsafe ChemistryStationConfigPanel()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ChemistryStationConfigPanel>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public ChemistryStationConfigPanel(IntPtr pointer)
		: base(pointer)
	{
	}
}

...
public class PromptImageWithText : PromptImage
{
	...
	static PromptImageWithText()
	{
		...
		NativeFieldInfoPtr_Label = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PromptImageWithText>.NativeClassPtr, "Label");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PromptImageWithText>.NativeClassPtr, 100689195);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 0, XrefRangeEnd = 0, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe PromptImageWithText()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PromptImageWithText>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public PromptImageWithText(IntPtr pointer)
		: base(pointer)
	{
	}
}

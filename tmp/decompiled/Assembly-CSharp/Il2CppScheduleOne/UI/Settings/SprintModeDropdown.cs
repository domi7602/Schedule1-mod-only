...
public class SprintModeDropdown : SettingsDropdown
{
	...
	static SprintModeDropdown()
	{
		...
		NativeMethodInfoPtr_Awake_Protected_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SprintModeDropdown>.NativeClassPtr, 100687899);
		NativeMethodInfoPtr_Start_Protected_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SprintModeDropdown>.NativeClassPtr, 100687900);
		NativeMethodInfoPtr_OnValueChanged_Protected_Virtual_Void_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SprintModeDropdown>.NativeClassPtr, 100687901);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SprintModeDropdown>.NativeClassPtr, 100687902);
	}
	...
	public unsafe SprintModeDropdown()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<SprintModeDropdown>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public SprintModeDropdown(IntPtr pointer)
		: base(pointer)
	{
	}
}

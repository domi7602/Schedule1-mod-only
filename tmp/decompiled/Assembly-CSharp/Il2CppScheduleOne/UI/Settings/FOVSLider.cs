...
public class FOVSLider : SettingsSlider
{
	...
	static FOVSLider()
	{
		...
		NativeMethodInfoPtr_Start_Protected_Virtual_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FOVSLider>.NativeClassPtr, 100687806);
		NativeMethodInfoPtr_OnValueChanged_Protected_Virtual_Void_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FOVSLider>.NativeClassPtr, 100687807);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FOVSLider>.NativeClassPtr, 100687808);
	}
	...
	public unsafe FOVSLider()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<FOVSLider>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public FOVSLider(IntPtr pointer)
		: base(pointer)
	{
	}
}

...
public class TrashGrabberItemUI : ItemUI
{
	...
	static TrashGrabberItemUI()
	{
		...
		NativeFieldInfoPtr_ValueLabel = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TrashGrabberItemUI>.NativeClassPtr, "ValueLabel");
		NativeFieldInfoPtr_trashGrabberInstance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TrashGrabberItemUI>.NativeClassPtr, "trashGrabberInstance");
		NativeMethodInfoPtr_Setup_Public_Virtual_Void_ItemInstance_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TrashGrabberItemUI>.NativeClassPtr, 100689552);
		NativeMethodInfoPtr_UpdateUI_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TrashGrabberItemUI>.NativeClassPtr, 100689553);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TrashGrabberItemUI>.NativeClassPtr, 100689554);
	}
	...
	public unsafe TrashGrabberItemUI()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<TrashGrabberItemUI>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public TrashGrabberItemUI(IntPtr pointer)
		: base(pointer)
	{
	}
}

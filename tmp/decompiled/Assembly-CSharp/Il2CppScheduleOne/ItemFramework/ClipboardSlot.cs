...
public class ClipboardSlot : HotbarSlot
{
	...
	static ClipboardSlot()
	{
		...
		NativeMethodInfoPtr_ClearStoredInstance_Public_Virtual_Void_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ClipboardSlot>.NativeClassPtr, 100672467);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ClipboardSlot>.NativeClassPtr, 100672468);
	}
	...
	public unsafe ClipboardSlot()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ClipboardSlot>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public ClipboardSlot(IntPtr pointer)
		: base(pointer)
	{
	}
}

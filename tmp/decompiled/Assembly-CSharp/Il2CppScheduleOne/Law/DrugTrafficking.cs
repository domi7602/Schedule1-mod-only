...
public class DrugTrafficking : Crime
{
	...
	static DrugTrafficking()
	{
		...
		NativeFieldInfoPtr__CrimeName_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DrugTrafficking>.NativeClassPtr, "<CrimeName>k__BackingField");
		NativeMethodInfoPtr_get_CrimeName_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DrugTrafficking>.NativeClassPtr, 100671165);
		NativeMethodInfoPtr_set_CrimeName_Protected_Virtual_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DrugTrafficking>.NativeClassPtr, 100671166);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DrugTrafficking>.NativeClassPtr, 100671167);
	}
	...
	public unsafe DrugTrafficking()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<DrugTrafficking>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public DrugTrafficking(IntPtr pointer)
		: base(pointer)
	{
	}
}

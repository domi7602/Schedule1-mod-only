...
public class TransportingIllicitItems : Crime
{
	...
	static TransportingIllicitItems()
	{
		...
		NativeFieldInfoPtr__CrimeName_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TransportingIllicitItems>.NativeClassPtr, "<CrimeName>k__BackingField");
		NativeMethodInfoPtr_get_CrimeName_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TransportingIllicitItems>.NativeClassPtr, 100671171);
		NativeMethodInfoPtr_set_CrimeName_Protected_Virtual_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TransportingIllicitItems>.NativeClassPtr, 100671172);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TransportingIllicitItems>.NativeClassPtr, 100671173);
	}
	...
	public unsafe TransportingIllicitItems()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<TransportingIllicitItems>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public TransportingIllicitItems(IntPtr pointer)
		: base(pointer)
	{
	}
}

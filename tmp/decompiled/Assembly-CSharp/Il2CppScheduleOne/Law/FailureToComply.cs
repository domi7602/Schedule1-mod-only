...
public class FailureToComply : Crime
{
	...
	static FailureToComply()
	{
		...
		NativeFieldInfoPtr__CrimeName_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<FailureToComply>.NativeClassPtr, "<CrimeName>k__BackingField");
		NativeMethodInfoPtr_get_CrimeName_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FailureToComply>.NativeClassPtr, 100671168);
		NativeMethodInfoPtr_set_CrimeName_Protected_Virtual_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FailureToComply>.NativeClassPtr, 100671169);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FailureToComply>.NativeClassPtr, 100671170);
	}
	...
	public unsafe FailureToComply()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<FailureToComply>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public FailureToComply(IntPtr pointer)
		: base(pointer)
	{
	}
}

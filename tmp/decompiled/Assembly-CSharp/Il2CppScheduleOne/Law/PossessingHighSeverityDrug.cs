...
public class PossessingHighSeverityDrug : Crime
{
	...
	static PossessingHighSeverityDrug()
	{
		...
		NativeFieldInfoPtr__CrimeName_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PossessingHighSeverityDrug>.NativeClassPtr, "<CrimeName>k__BackingField");
		NativeMethodInfoPtr_get_CrimeName_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PossessingHighSeverityDrug>.NativeClassPtr, 100671156);
		NativeMethodInfoPtr_set_CrimeName_Protected_Virtual_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PossessingHighSeverityDrug>.NativeClassPtr, 100671157);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PossessingHighSeverityDrug>.NativeClassPtr, 100671158);
	}
	...
	public unsafe PossessingHighSeverityDrug()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PossessingHighSeverityDrug>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public PossessingHighSeverityDrug(IntPtr pointer)
		: base(pointer)
	{
	}
}

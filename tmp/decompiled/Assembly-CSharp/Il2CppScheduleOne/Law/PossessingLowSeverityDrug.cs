...
public class PossessingLowSeverityDrug : Crime
{
	...
	static PossessingLowSeverityDrug()
	{
		...
		NativeFieldInfoPtr__CrimeName_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PossessingLowSeverityDrug>.NativeClassPtr, "<CrimeName>k__BackingField");
		NativeMethodInfoPtr_get_CrimeName_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PossessingLowSeverityDrug>.NativeClassPtr, 100671150);
		NativeMethodInfoPtr_set_CrimeName_Protected_Virtual_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PossessingLowSeverityDrug>.NativeClassPtr, 100671151);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PossessingLowSeverityDrug>.NativeClassPtr, 100671152);
	}
	...
	public unsafe PossessingLowSeverityDrug()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PossessingLowSeverityDrug>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public PossessingLowSeverityDrug(IntPtr pointer)
		: base(pointer)
	{
	}
}

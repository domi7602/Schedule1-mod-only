...
public class DischargeFirearm : Crime
{
	...
	static DischargeFirearm()
	{
		...
		NativeFieldInfoPtr__CrimeName_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DischargeFirearm>.NativeClassPtr, "<CrimeName>k__BackingField");
		NativeMethodInfoPtr_get_CrimeName_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DischargeFirearm>.NativeClassPtr, 100671195);
		NativeMethodInfoPtr_set_CrimeName_Protected_Virtual_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DischargeFirearm>.NativeClassPtr, 100671196);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DischargeFirearm>.NativeClassPtr, 100671197);
	}
	...
	public unsafe DischargeFirearm()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<DischargeFirearm>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public DischargeFirearm(IntPtr pointer)
		: base(pointer)
	{
	}
}

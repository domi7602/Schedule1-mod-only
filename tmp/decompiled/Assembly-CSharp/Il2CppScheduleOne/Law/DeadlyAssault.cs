...
public class DeadlyAssault : Crime
{
	...
	static DeadlyAssault()
	{
		...
		NativeFieldInfoPtr__CrimeName_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DeadlyAssault>.NativeClassPtr, "<CrimeName>k__BackingField");
		NativeMethodInfoPtr_get_CrimeName_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DeadlyAssault>.NativeClassPtr, 100671183);
		NativeMethodInfoPtr_set_CrimeName_Protected_Virtual_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DeadlyAssault>.NativeClassPtr, 100671184);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DeadlyAssault>.NativeClassPtr, 100671185);
	}
	...
	public unsafe DeadlyAssault()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<DeadlyAssault>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public DeadlyAssault(IntPtr pointer)
		: base(pointer)
	{
	}
}

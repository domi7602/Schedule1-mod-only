...
public class AttemptingToSell : Crime
{
	...
	static AttemptingToSell()
	{
		...
		NativeFieldInfoPtr__CrimeName_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AttemptingToSell>.NativeClassPtr, "<CrimeName>k__BackingField");
		NativeMethodInfoPtr_get_CrimeName_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AttemptingToSell>.NativeClassPtr, 100671177);
		NativeMethodInfoPtr_set_CrimeName_Protected_Virtual_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AttemptingToSell>.NativeClassPtr, 100671178);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AttemptingToSell>.NativeClassPtr, 100671179);
	}
	...
	public unsafe AttemptingToSell()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AttemptingToSell>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public AttemptingToSell(IntPtr pointer)
		: base(pointer)
	{
	}
}

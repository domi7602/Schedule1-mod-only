...
public class Euphoric : Effect
{
	...
	static Euphoric()
	{
		...
		NativeMethodInfoPtr_ApplyToNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Euphoric>.NativeClassPtr, 100685379);
		NativeMethodInfoPtr_ApplyToPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Euphoric>.NativeClassPtr, 100685380);
		NativeMethodInfoPtr_ClearFromNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Euphoric>.NativeClassPtr, 100685381);
		NativeMethodInfoPtr_ClearFromPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Euphoric>.NativeClassPtr, 100685382);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Euphoric>.NativeClassPtr, 100685383);
	}
	...
	public unsafe Euphoric()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Euphoric>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public Euphoric(IntPtr pointer)
		: base(pointer)
	{
	}
}

...
public class Cyclopean : Effect
{
	...
	static Cyclopean()
	{
		...
		NativeMethodInfoPtr_ApplyToNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Cyclopean>.NativeClassPtr, 100685354);
		NativeMethodInfoPtr_ApplyToPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Cyclopean>.NativeClassPtr, 100685355);
		NativeMethodInfoPtr_ClearFromNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Cyclopean>.NativeClassPtr, 100685356);
		NativeMethodInfoPtr_ClearFromPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Cyclopean>.NativeClassPtr, 100685357);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Cyclopean>.NativeClassPtr, 100685358);
	}
	...
	public unsafe Cyclopean()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Cyclopean>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public Cyclopean(IntPtr pointer)
		: base(pointer)
	{
	}
}

...
public class Disorienting : Effect
{
	...
	static Disorienting()
	{
		...
		NativeMethodInfoPtr_ApplyToNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Disorienting>.NativeClassPtr, 100685359);
		NativeMethodInfoPtr_ApplyToPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Disorienting>.NativeClassPtr, 100685360);
		NativeMethodInfoPtr_ClearFromNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Disorienting>.NativeClassPtr, 100685361);
		NativeMethodInfoPtr_ClearFromPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Disorienting>.NativeClassPtr, 100685362);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Disorienting>.NativeClassPtr, 100685363);
	}
	...
	public unsafe Disorienting()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Disorienting>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public Disorienting(IntPtr pointer)
		: base(pointer)
	{
	}
}

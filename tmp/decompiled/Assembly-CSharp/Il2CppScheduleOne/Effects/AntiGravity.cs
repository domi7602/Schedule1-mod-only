...
public class AntiGravity : Effect
{
	...
	static AntiGravity()
	{
		...
		NativeFieldInfoPtr_GravityMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<AntiGravity>.NativeClassPtr, "GravityMultiplier");
		NativeMethodInfoPtr_ApplyToNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AntiGravity>.NativeClassPtr, 100685322);
		NativeMethodInfoPtr_ApplyToPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AntiGravity>.NativeClassPtr, 100685323);
		NativeMethodInfoPtr_ClearFromNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AntiGravity>.NativeClassPtr, 100685324);
		NativeMethodInfoPtr_ClearFromPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AntiGravity>.NativeClassPtr, 100685325);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AntiGravity>.NativeClassPtr, 100685326);
	}
	...
	public unsafe AntiGravity()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<AntiGravity>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public AntiGravity(IntPtr pointer)
		: base(pointer)
	{
	}
}

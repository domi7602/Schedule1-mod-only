...
public class Quest_Cleaners : Quest_Employees
{
	...
	static Quest_Cleaners()
	{
		...
		NativeFieldInfoPtr_AssignWorkEntry = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Quest_Cleaners>.NativeClassPtr, "AssignWorkEntry");
		NativeMethodInfoPtr_OnUncappedMinPass_Protected_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Quest_Cleaners>.NativeClassPtr, 100667634);
		NativeMethodInfoPtr_GetEmployees_Public_Virtual_List_1_Employee_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Quest_Cleaners>.NativeClassPtr, 100667635);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Quest_Cleaners>.NativeClassPtr, 100667636);
	}
	...
	public unsafe Quest_Cleaners()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Quest_Cleaners>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public Quest_Cleaners(IntPtr pointer)
		: base(pointer)
	{
	}
}

...
public class OverrideGhostMaterial : MonoBehaviour
{
	...
	static OverrideGhostMaterial()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OverrideGhostMaterial>.NativeClassPtr, 100676671);
	}

	[CallerCount(204)]
	[CachedScanResults(RefRangeStart = 152, RefRangeEnd = 356, XrefRangeStart = 152, XrefRangeEnd = 356, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe OverrideGhostMaterial()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<OverrideGhostMaterial>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public OverrideGhostMaterial(IntPtr pointer)
		: base(pointer)
	{
	}
}

...
| **AutoPackagingStation** | ✅ active (v0.2.7, **Bug-Report-Runde 6 2026-09-13 / v0.4.6f13, Verified 2026-09-19**) | `Mods/AutoPackagingStation/` | `AutoPackagingStation.dll` | yes (4x4 Industrial Packaging Line + UV Scroll Conveyor + Native Slot Sync + SafeStorage + Shop Injection) |

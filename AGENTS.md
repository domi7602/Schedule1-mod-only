...
| **PotScanner**   | ✅ active (v0.5.3, **Verified 2026-09-15**) | `Mods/PotScanner/` | `PotScanner.dll` | yes (PhoneApp + Property + Growing + Money + Lifecycle APIs + ModConfig + Console/BaseConsoleCommand) |
...
| **PocketShop** | ✅ active (v0.2.5, **Verified 2026-09-15**) | `Mods/PocketShop/` | `PocketShop.dll` | yes (PhoneApp + Multi-Payment (Cash/Bank/Auto) + ItemDetailModal + SFX) |
...
| **HomelessMod** | ✅ active (v0.1.9, **Verified 2026-09-15**) | `Mods/HomelessMod/` | `HomelessMod.dll` | yes (Street Nomad + Everywhere Building + 3D Procedural Sleeping Bag + Quests + Console + Save-Slot Isolation) |
| **BusinessIncome** | ✅ active (v0.1.5, **Verified 2026-09-15**) | `Mods/BusinessIncome/` | `BusinessIncome.dll` | yes (Daily Passive Revenue + Multiplayer Host Authority + Slot Idempotency + Deterministic Variance + Console Dashboard) |
...
| **StackLimitMod** | ✅ active (v0.1.4, **Agriculture-Only Mode & Weapon-Shield 2026-09-15 / v0.4.6f13, In-Game-Verify offen**) | `Mods/StackLimitMod/` | `StackLimitMod.dll` | yes (BaseItemDefinition + Registry + BaseItemInstance Harmony Patches + Console + SafeStorage) |
...
| **HitmanPhone** | ✅ active (v0.2.8, **KnockOut-Hook + Single-Drop-Latch + Orphan-Cleanup, Verified 2026-09-15**) | `Mods/HitmanPhone/` | `HitmanPhone.dll` | yes (MessagesApp Contracts + NPC + Items + Quests + SafeStorage) |
...
**HitmanPhone v0.2.8 (2026-09-15, KnockOut & Quest-Lifecycle In-Game-Verified):**

...
* **SnackVendor** (v0.0.4): Work in progress — player-stocked vending machine that sells gas-market ingredients to NPCs for passive cash (MVP; in-game verification pending).

...
`HomelessMod` uses `S1API.Items.Buildable` for the procedural SleepingBag. See `Source/Archive/SnackVendor/src/Items/SnackVendorItemFactory.cs` for a production pattern.

...
| Building / Grid / outdoor placement? | `references/10-Building-Construction.md` + `references/59-TilesGrid.md` | `schedule1-grid` skill + `Source/Archive/HomelessMod/src/` (7 Golden Rules) |

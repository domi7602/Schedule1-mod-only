...
The script reads `<GameDir>\MelonLoader\Il2CppAssemblies`, installs `ilspycmd` into the ignored `.tools/` directory when needed, and writes decompiles to `GameReferences/decompiled/`.

...
public class ForcePlayerCrouch : MonoBehaviour
{
	...
	static ForcePlayerCrouch()
	{
		...
		NativeMethodInfoPtr_OnTriggerEnter_Private_Void_Collider_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ForcePlayerCrouch>.NativeClassPtr, 100678032);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ForcePlayerCrouch>.NativeClassPtr, 100678033);
	}
	...
	public unsafe ForcePlayerCrouch()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ForcePlayerCrouch>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public ForcePlayerCrouch(IntPtr pointer)
		: base(pointer)
	{
	}
}

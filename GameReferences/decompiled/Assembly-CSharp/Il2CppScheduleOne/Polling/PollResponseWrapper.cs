...
public class PollResponseWrapper : Il2CppSystem.Object
{
	...
	public unsafe PollResponse data
	{
		...
		set
		{
			...
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (System.IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_data)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)pollResponse));
		}
	}
	...
	static PollResponseWrapper()
	{
		...
		NativeFieldInfoPtr_success = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PollResponseWrapper>.NativeClassPtr, "success");
		NativeFieldInfoPtr_data = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PollResponseWrapper>.NativeClassPtr, "data");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PollResponseWrapper>.NativeClassPtr, 100668155);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe PollResponseWrapper()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PollResponseWrapper>.NativeClassPtr))
	{
	...
	public PollResponseWrapper(System.IntPtr pointer)
		: base(pointer)
	{
	}
}

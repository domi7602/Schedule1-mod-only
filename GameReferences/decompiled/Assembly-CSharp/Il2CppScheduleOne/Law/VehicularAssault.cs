...
public class VehicularAssault : Crime
{
	...
	static VehicularAssault()
	{
		...
		NativeFieldInfoPtr__CrimeName_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<VehicularAssault>.NativeClassPtr, "<CrimeName>k__BackingField");
		NativeMethodInfoPtr_get_CrimeName_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VehicularAssault>.NativeClassPtr, 100671162);
		NativeMethodInfoPtr_set_CrimeName_Protected_Virtual_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VehicularAssault>.NativeClassPtr, 100671163);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VehicularAssault>.NativeClassPtr, 100671164);
	}
	...
	public unsafe VehicularAssault()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<VehicularAssault>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public VehicularAssault(IntPtr pointer)
		: base(pointer)
	{
	}
}

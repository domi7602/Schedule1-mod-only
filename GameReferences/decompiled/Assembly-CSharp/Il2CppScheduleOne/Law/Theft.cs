...
public class Theft : Crime
{
	...
	static Theft()
	{
		...
		NativeFieldInfoPtr__CrimeName_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Theft>.NativeClassPtr, "<CrimeName>k__BackingField");
		NativeMethodInfoPtr_get_CrimeName_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Theft>.NativeClassPtr, 100671189);
		NativeMethodInfoPtr_set_CrimeName_Protected_Virtual_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Theft>.NativeClassPtr, 100671190);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Theft>.NativeClassPtr, 100671191);
	}
	...
	public unsafe Theft()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Theft>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);

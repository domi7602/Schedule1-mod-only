...
public class BrandishingWeapon : Crime
{
	...
	static BrandishingWeapon()
	{
		...
		NativeFieldInfoPtr__CrimeName_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<BrandishingWeapon>.NativeClassPtr, "<CrimeName>k__BackingField");
		NativeMethodInfoPtr_get_CrimeName_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BrandishingWeapon>.NativeClassPtr, 100671192);
		NativeMethodInfoPtr_set_CrimeName_Protected_Virtual_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BrandishingWeapon>.NativeClassPtr, 100671193);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BrandishingWeapon>.NativeClassPtr, 100671194);
	}
	...
	public unsafe BrandishingWeapon()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<BrandishingWeapon>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public BrandishingWeapon(IntPtr pointer)
		: base(pointer)
	{
	}
}

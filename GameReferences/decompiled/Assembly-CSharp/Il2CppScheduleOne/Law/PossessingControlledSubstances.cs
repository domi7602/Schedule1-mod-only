...
public class PossessingControlledSubstances : Crime
{
	...
	static PossessingControlledSubstances()
	{
		...
		NativeFieldInfoPtr__CrimeName_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PossessingControlledSubstances>.NativeClassPtr, "<CrimeName>k__BackingField");
		NativeMethodInfoPtr_get_CrimeName_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PossessingControlledSubstances>.NativeClassPtr, 100671147);
		NativeMethodInfoPtr_set_CrimeName_Protected_Virtual_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PossessingControlledSubstances>.NativeClassPtr, 100671148);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PossessingControlledSubstances>.NativeClassPtr, 100671149);
	}
	...
	public unsafe PossessingControlledSubstances()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PossessingControlledSubstances>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public PossessingControlledSubstances(IntPtr pointer)
		: base(pointer)
	{
	}
}

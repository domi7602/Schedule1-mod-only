...
public class PossessingModerateSeverityDrug : Crime
{
	...
	static PossessingModerateSeverityDrug()
	{
		...
		NativeFieldInfoPtr__CrimeName_k__BackingField = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PossessingModerateSeverityDrug>.NativeClassPtr, "<CrimeName>k__BackingField");
		NativeMethodInfoPtr_get_CrimeName_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PossessingModerateSeverityDrug>.NativeClassPtr, 100671153);
		NativeMethodInfoPtr_set_CrimeName_Protected_Virtual_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PossessingModerateSeverityDrug>.NativeClassPtr, 100671154);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PossessingModerateSeverityDrug>.NativeClassPtr, 100671155);
	}
	...
	public unsafe PossessingModerateSeverityDrug()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PossessingModerateSeverityDrug>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public PossessingModerateSeverityDrug(IntPtr pointer)
		: base(pointer)
	{
	}
}

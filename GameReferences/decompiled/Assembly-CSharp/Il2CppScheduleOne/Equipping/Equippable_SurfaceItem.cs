...
public class Equippable_SurfaceItem : Equippable
{
	...
	static Equippable_SurfaceItem()
	{
		...
		NativeFieldInfoPtr_isBuilding = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Equippable_SurfaceItem>.NativeClassPtr, "isBuilding");
		NativeMethodInfoPtr_Update_Protected_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Equippable_SurfaceItem>.NativeClassPtr, 100679866);
		NativeMethodInfoPtr_Unequip_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Equippable_SurfaceItem>.NativeClassPtr, 100679867);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Equippable_SurfaceItem>.NativeClassPtr, 100679868);
	}
	...
	public unsafe Equippable_SurfaceItem()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Equippable_SurfaceItem>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public Equippable_SurfaceItem(IntPtr pointer)
		: base(pointer)
	{
	}
}

...
public class ACAccessoryReplicator : ACAssetPathReplicator<Accessory>
{
	...
	static ACAccessoryReplicator()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ACAccessoryReplicator>.NativeClassPtr, 100677602);
	}
	...
	public unsafe ACAccessoryReplicator()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ACAccessoryReplicator>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public ACAccessoryReplicator(IntPtr pointer)
		: base(pointer)
	{
	}
}

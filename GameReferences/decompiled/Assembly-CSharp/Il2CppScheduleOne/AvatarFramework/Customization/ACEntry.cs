...
public class ACEntry : MonoBehaviour
{
	...
	static ACEntry()
	{
		...
		NativeFieldInfoPtr_DevOnly = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ACEntry>.NativeClassPtr, "DevOnly");
		NativeMethodInfoPtr_Awake_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ACEntry>.NativeClassPtr, 100677549);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ACEntry>.NativeClassPtr, 100677550);
	}
	...
	public unsafe ACEntry()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ACEntry>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);

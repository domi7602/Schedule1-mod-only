...
public class LiquidMeth_Stored : StoredItem
{
	...
	static LiquidMeth_Stored()
	{
		...
		NativeFieldInfoPtr_Visuals = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<LiquidMeth_Stored>.NativeClassPtr, "Visuals");
		NativeMethodInfoPtr_InitializeStoredItem_Public_Virtual_Void_StorableItemInstance_StorageGrid_Vector2_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LiquidMeth_Stored>.NativeClassPtr, 100678671);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LiquidMeth_Stored>.NativeClassPtr, 100678672);
	}
	...
	public unsafe LiquidMeth_Stored()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<LiquidMeth_Stored>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public LiquidMeth_Stored(IntPtr pointer)
		: base(pointer)
	{
	}
}

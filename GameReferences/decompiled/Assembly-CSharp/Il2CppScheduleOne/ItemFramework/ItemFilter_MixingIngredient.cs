...
public class ItemFilter_MixingIngredient : ItemFilter
{
	...
	static ItemFilter_MixingIngredient()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ItemFilter_MixingIngredient>.NativeClassPtr, 100672486);
		NativeMethodInfoPtr_DoesItemMatchFilter_Public_Virtual_Boolean_ItemInstance_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ItemFilter_MixingIngredient>.NativeClassPtr, 100672487);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ItemFilter_MixingIngredient()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ItemFilter_MixingIngredient>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public ItemFilter_MixingIngredient(IntPtr pointer)
		: base(pointer)
	{
	}
}

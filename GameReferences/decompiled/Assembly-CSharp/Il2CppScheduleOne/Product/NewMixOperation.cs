...
public class NewMixOperation : Il2CppSystem.Object
{
	...
	static NewMixOperation()
	{
		...
		NativeFieldInfoPtr_ProductID = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NewMixOperation>.NativeClassPtr, "ProductID");
		NativeFieldInfoPtr_IngredientID = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NewMixOperation>.NativeClassPtr, "IngredientID");
		NativeMethodInfoPtr__ctor_Public_Void_String_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NewMixOperation>.NativeClassPtr, 100679255);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NewMixOperation>.NativeClassPtr, 100679256);
	}
	...
	public unsafe NewMixOperation(string productID, string ingredientID)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<NewMixOperation>.NativeClassPtr))
	{
	...
	public NewMixOperation(System.IntPtr pointer)
		: base(pointer)
	{
	}
}

...
public class WeedInstance : ProductItemInstance
{
	...
	static WeedInstance()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_ItemDefinition_Int32_EQuality_PackagingDefinition_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WeedInstance>.NativeClassPtr, 100679683);
		NativeMethodInfoPtr_GetCopy_Public_Virtual_ItemInstance_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WeedInstance>.NativeClassPtr, 100679684);
		NativeMethodInfoPtr_GetItemData_Public_Virtual_ItemData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WeedInstance>.NativeClassPtr, 100679685);
		NativeMethodInfoPtr_ApplyEffectsToNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WeedInstance>.NativeClassPtr, 100679686);
		NativeMethodInfoPtr_ClearEffectsFromNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WeedInstance>.NativeClassPtr, 100679687);
		NativeMethodInfoPtr_ApplyEffectsToPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WeedInstance>.NativeClassPtr, 100679688);
		NativeMethodInfoPtr_ClearEffectsFromPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WeedInstance>.NativeClassPtr, 100679689);
	}
	...
	public unsafe WeedInstance(ItemDefinition definition, int quantity, EQuality quality, PackagingDefinition packaging = null)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<WeedInstance>.NativeClassPtr))
	{
	...
	public WeedInstance(IntPtr pointer)
		: base(pointer)
	{
	}
}

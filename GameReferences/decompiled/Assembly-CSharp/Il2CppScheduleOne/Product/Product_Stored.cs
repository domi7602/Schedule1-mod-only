...
public class Product_Stored : StoredItem
{
	...
	static Product_Stored()
	{
		...
		NativeFieldInfoPtr_Visuals = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Product_Stored>.NativeClassPtr, "Visuals");
		NativeMethodInfoPtr_InitializeStoredItem_Public_Virtual_Void_StorableItemInstance_StorageGrid_Vector2_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Product_Stored>.NativeClassPtr, 100679570);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Product_Stored>.NativeClassPtr, 100679571);
	}
	...
	public unsafe Product_Stored()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Product_Stored>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public Product_Stored(IntPtr pointer)
		: base(pointer)
	{
	}
}

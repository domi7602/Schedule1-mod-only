...
public class LiquidMeth_StationItem : StationItem
{
	...
	static LiquidMeth_StationItem()
	{
		...
		NativeFieldInfoPtr_Visuals = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<LiquidMeth_StationItem>.NativeClassPtr, "Visuals");
		NativeMethodInfoPtr_Initialize_Public_Virtual_Void_StorableItemDefinition_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LiquidMeth_StationItem>.NativeClassPtr, 100678887);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LiquidMeth_StationItem>.NativeClassPtr, 100678888);
	}
	...
	public unsafe LiquidMeth_StationItem()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<LiquidMeth_StationItem>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public LiquidMeth_StationItem(IntPtr pointer)
		: base(pointer)
	{
	}
}

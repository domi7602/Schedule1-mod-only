...
public class LiquidVolumeCollider : MonoBehaviour
{
	...
	static LiquidVolumeCollider()
	{
		...
		NativeFieldInfoPtr_LiquidContainer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<LiquidVolumeCollider>.NativeClassPtr, "LiquidContainer");
		NativeMethodInfoPtr_Awake_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LiquidVolumeCollider>.NativeClassPtr, 100678968);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LiquidVolumeCollider>.NativeClassPtr, 100678969);
	}
	...
	public unsafe LiquidVolumeCollider()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<LiquidVolumeCollider>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public LiquidVolumeCollider(IntPtr pointer)
		: base(pointer)
	{
	}
}

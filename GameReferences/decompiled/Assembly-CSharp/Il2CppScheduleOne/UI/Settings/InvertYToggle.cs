...
public class InvertYToggle : SettingsToggle
{
	...
	static InvertYToggle()
	{
		...
		NativeMethodInfoPtr_Start_Protected_Virtual_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<InvertYToggle>.NativeClassPtr, 100687822);
		NativeMethodInfoPtr_OnValueChanged_Protected_Virtual_Void_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<InvertYToggle>.NativeClassPtr, 100687823);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<InvertYToggle>.NativeClassPtr, 100687824);
	}
	...
	public unsafe InvertYToggle()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<InvertYToggle>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public InvertYToggle(IntPtr pointer)
		: base(pointer)
	{
	}
}

...
public class DryingRackConfigPanel : ConfigPanel
{
	...
	public unsafe QualityFieldUI QualityUI
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_QualityUI);
			IntPtr intPtr = *(IntPtr*)num;
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<QualityFieldUI>(intPtr) : null;
		}
		set
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_QualityUI)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)qualityFieldUI));
		}
	}
	...
	public unsafe NumberFieldUI StartThresholdUI
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_StartThresholdUI);
			IntPtr intPtr = *(IntPtr*)num;
			return (intPtr != (IntPtr)0) ? Il2CppObjectPool.Get<NumberFieldUI>(intPtr) : null;
		}
		set
		{
			IntPtr num = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this);
			IL2CPP.il2cpp_gc_wbarrier_set_field(num, (IntPtr)((nint)num + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_StartThresholdUI)), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase)(object)numberFieldUI));
		}
	}
	...
	static DryingRackConfigPanel()
	{
		...
		NativeFieldInfoPtr_QualityUI = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DryingRackConfigPanel>.NativeClassPtr, "QualityUI");
		NativeFieldInfoPtr_DestinationUI = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DryingRackConfigPanel>.NativeClassPtr, "DestinationUI");
		NativeFieldInfoPtr_StartThresholdUI = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DryingRackConfigPanel>.NativeClassPtr, "StartThresholdUI");
		NativeMethodInfoPtr_BindInternal_Protected_Virtual_Void_List_1_EntityConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DryingRackConfigPanel>.NativeClassPtr, 100688643);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DryingRackConfigPanel>.NativeClassPtr, 100688644);
	}
	...
	public unsafe DryingRackConfigPanel()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<DryingRackConfigPanel>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public DryingRackConfigPanel(IntPtr pointer)
		: base(pointer)
	{
	}
}

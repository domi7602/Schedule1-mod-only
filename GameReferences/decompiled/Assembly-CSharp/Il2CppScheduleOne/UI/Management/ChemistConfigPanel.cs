...
public class ChemistConfigPanel : ConfigPanel
{
	...
	static ChemistConfigPanel()
	{
		...
		NativeFieldInfoPtr_BedUI = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ChemistConfigPanel>.NativeClassPtr, "BedUI");
		NativeFieldInfoPtr_StationsUI = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ChemistConfigPanel>.NativeClassPtr, "StationsUI");
		NativeMethodInfoPtr_BindInternal_Protected_Virtual_Void_List_1_EntityConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ChemistConfigPanel>.NativeClassPtr, 100688637);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ChemistConfigPanel>.NativeClassPtr, 100688638);
	}
	...
	public unsafe ChemistConfigPanel()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ChemistConfigPanel>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public ChemistConfigPanel(IntPtr pointer)
		: base(pointer)
	{
	}
}

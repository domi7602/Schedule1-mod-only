...
public class CauldronConfigPanel : ConfigPanel
{
	...
	static CauldronConfigPanel()
	{
		...
		NativeFieldInfoPtr_DestinationUI = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CauldronConfigPanel>.NativeClassPtr, "DestinationUI");
		NativeMethodInfoPtr_BindInternal_Protected_Virtual_Void_List_1_EntityConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CauldronConfigPanel>.NativeClassPtr, 100688635);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CauldronConfigPanel>.NativeClassPtr, 100688636);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 322886, XrefRangeEnd = 322921, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe CauldronConfigPanel()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CauldronConfigPanel>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public CauldronConfigPanel(IntPtr pointer)
		: base(pointer)
	{
	}
}

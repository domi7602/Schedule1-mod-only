...
public class PackagingStationConfigPanel : ConfigPanel
{
	...
	static PackagingStationConfigPanel()
	{
		...
		NativeFieldInfoPtr_DestinationUI = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PackagingStationConfigPanel>.NativeClassPtr, "DestinationUI");
		NativeMethodInfoPtr_BindInternal_Protected_Virtual_Void_List_1_EntityConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PackagingStationConfigPanel>.NativeClassPtr, 100688653);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PackagingStationConfigPanel>.NativeClassPtr, 100688654);
	}
	...
	public unsafe PackagingStationConfigPanel()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PackagingStationConfigPanel>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public PackagingStationConfigPanel(IntPtr pointer)
		: base(pointer)
	{
	}
}

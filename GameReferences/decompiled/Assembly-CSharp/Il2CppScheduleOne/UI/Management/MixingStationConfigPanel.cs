...
public class MixingStationConfigPanel : ConfigPanel
{
	...
	static MixingStationConfigPanel()
	{
		...
		NativeFieldInfoPtr_DestinationUI = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MixingStationConfigPanel>.NativeClassPtr, "DestinationUI");
		NativeFieldInfoPtr_StartThresholdUI = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MixingStationConfigPanel>.NativeClassPtr, "StartThresholdUI");
		NativeMethodInfoPtr_BindInternal_Protected_Virtual_Void_List_1_EntityConfiguration_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MixingStationConfigPanel>.NativeClassPtr, 100688647);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MixingStationConfigPanel>.NativeClassPtr, 100688648);
	}
	...
	public unsafe MixingStationConfigPanel()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<MixingStationConfigPanel>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public MixingStationConfigPanel(IntPtr pointer)
		: base(pointer)
	{
	}
}

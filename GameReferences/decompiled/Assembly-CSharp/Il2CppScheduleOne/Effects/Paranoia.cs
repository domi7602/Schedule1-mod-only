...
public class Paranoia : Effect
{
	...
	static Paranoia()
	{
		...
		NativeMethodInfoPtr_ApplyToNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Paranoia>.NativeClassPtr, 100685437);
		NativeMethodInfoPtr_ApplyToPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Paranoia>.NativeClassPtr, 100685438);
		NativeMethodInfoPtr_ClearFromNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Paranoia>.NativeClassPtr, 100685439);
		NativeMethodInfoPtr_ClearFromPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Paranoia>.NativeClassPtr, 100685440);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Paranoia>.NativeClassPtr, 100685441);
	}
	...
	public unsafe Paranoia()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Paranoia>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public Paranoia(IntPtr pointer)
		: base(pointer)
	{
	}
}

...
public class TropicThunder : Effect
{
	...
	static TropicThunder()
	{
		...
		NativeMethodInfoPtr_ApplyToNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TropicThunder>.NativeClassPtr, 100685515);
		NativeMethodInfoPtr_ApplyToPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TropicThunder>.NativeClassPtr, 100685516);
		NativeMethodInfoPtr_ClearFromNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TropicThunder>.NativeClassPtr, 100685517);
		NativeMethodInfoPtr_ClearFromPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TropicThunder>.NativeClassPtr, 100685518);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TropicThunder>.NativeClassPtr, 100685519);
	}
	...
	public unsafe TropicThunder()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<TropicThunder>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public TropicThunder(IntPtr pointer)
		: base(pointer)
	{
	}
}

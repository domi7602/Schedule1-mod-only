...
public class Glowie : Effect
{
	...
	public unsafe Color GlowColor
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_GlowColor);
			return *(Color*)num;
		}
		set
		{
			*(Color*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_GlowColor)) = color;
		}
	}
	...
	static Glowie()
	{
		...
		NativeFieldInfoPtr_GlowColor = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Glowie>.NativeClassPtr, "GlowColor");
		NativeMethodInfoPtr_ApplyToNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Glowie>.NativeClassPtr, 100685412);
		NativeMethodInfoPtr_ApplyToPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Glowie>.NativeClassPtr, 100685413);
		NativeMethodInfoPtr_ClearFromNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Glowie>.NativeClassPtr, 100685414);
		NativeMethodInfoPtr_ClearFromPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Glowie>.NativeClassPtr, 100685415);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Glowie>.NativeClassPtr, 100685416);
	}
	...
	public unsafe Glowie()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Glowie>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);

...
public class Jennerising : Effect
{
	...
	static Jennerising()
	{
		...
		NativeMethodInfoPtr_ApplyToNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Jennerising>.NativeClassPtr, 100685417);
		NativeMethodInfoPtr_ApplyToPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Jennerising>.NativeClassPtr, 100685418);
		NativeMethodInfoPtr_ClearFromNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Jennerising>.NativeClassPtr, 100685419);
		NativeMethodInfoPtr_ClearFromPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Jennerising>.NativeClassPtr, 100685420);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Jennerising>.NativeClassPtr, 100685421);
	}
	...
	public unsafe Jennerising()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Jennerising>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public Jennerising(IntPtr pointer)
		: base(pointer)
	{
	}
}

...
public class Laxative : Effect
{
	...
	static Laxative()
	{
		...
		NativeMethodInfoPtr_ApplyToNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Laxative>.NativeClassPtr, 100685422);
		NativeMethodInfoPtr_ApplyToPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Laxative>.NativeClassPtr, 100685423);
		NativeMethodInfoPtr_ClearFromNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Laxative>.NativeClassPtr, 100685424);
		NativeMethodInfoPtr_ClearFromPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Laxative>.NativeClassPtr, 100685425);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Laxative>.NativeClassPtr, 100685426);
	}
	...
	public unsafe Laxative()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Laxative>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public Laxative(IntPtr pointer)
		: base(pointer)
	{
	}
}

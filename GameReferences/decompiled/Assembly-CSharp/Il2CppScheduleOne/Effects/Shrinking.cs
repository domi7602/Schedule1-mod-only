...
public class Shrinking : Effect
{
	...
	static Shrinking()
	{
		...
		NativeFieldInfoPtr_Scale = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Shrinking>.NativeClassPtr, "Scale");
		NativeFieldInfoPtr_LerpTime = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Shrinking>.NativeClassPtr, "LerpTime");
		NativeMethodInfoPtr_ApplyToNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Shrinking>.NativeClassPtr, 100685480);
		NativeMethodInfoPtr_ApplyToPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Shrinking>.NativeClassPtr, 100685481);
		NativeMethodInfoPtr_ClearFromNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Shrinking>.NativeClassPtr, 100685482);
		NativeMethodInfoPtr_ClearFromPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Shrinking>.NativeClassPtr, 100685483);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Shrinking>.NativeClassPtr, 100685484);
	}
	...
	public unsafe Shrinking()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Shrinking>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public Shrinking(IntPtr pointer)
		: base(pointer)
	{
	}
}

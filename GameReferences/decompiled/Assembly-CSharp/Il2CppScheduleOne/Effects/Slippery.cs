...
public class Slippery : Effect
{
	...
	static Slippery()
	{
		...
		NativeMethodInfoPtr_ApplyToNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Slippery>.NativeClassPtr, 100685485);
		NativeMethodInfoPtr_ApplyToPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Slippery>.NativeClassPtr, 100685486);
		NativeMethodInfoPtr_ClearFromNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Slippery>.NativeClassPtr, 100685487);
		NativeMethodInfoPtr_ClearFromPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Slippery>.NativeClassPtr, 100685488);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Slippery>.NativeClassPtr, 100685489);
	}
	...
	public unsafe Slippery()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Slippery>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public Slippery(IntPtr pointer)
		: base(pointer)
	{
	}
}

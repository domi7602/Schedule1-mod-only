...
public class Refreshing : Effect
{
	...
	static Refreshing()
	{
		...
		NativeMethodInfoPtr_ApplyToNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Refreshing>.NativeClassPtr, 100685442);
		NativeMethodInfoPtr_ApplyToPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Refreshing>.NativeClassPtr, 100685443);
		NativeMethodInfoPtr_ClearFromNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Refreshing>.NativeClassPtr, 100685444);
		NativeMethodInfoPtr_ClearFromPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Refreshing>.NativeClassPtr, 100685445);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Refreshing>.NativeClassPtr, 100685446);
	}
	...
	public unsafe Refreshing()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Refreshing>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public Refreshing(IntPtr pointer)
		: base(pointer)
	{
	}
}

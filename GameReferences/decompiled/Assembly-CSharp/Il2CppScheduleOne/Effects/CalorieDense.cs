...
public class CalorieDense : Effect
{
	...
	static CalorieDense()
	{
		...
		NativeMethodInfoPtr_ApplyToNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CalorieDense>.NativeClassPtr, 100685349);
		NativeMethodInfoPtr_ApplyToPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CalorieDense>.NativeClassPtr, 100685350);
		NativeMethodInfoPtr_ClearFromNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CalorieDense>.NativeClassPtr, 100685351);
		NativeMethodInfoPtr_ClearFromPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CalorieDense>.NativeClassPtr, 100685352);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CalorieDense>.NativeClassPtr, 100685353);
	}
	...
	public unsafe CalorieDense()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CalorieDense>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public CalorieDense(IntPtr pointer)
		: base(pointer)
	{
	}
}

...
public class Gingeritis : Effect
{
	...
	public unsafe static Color32 Color
	{
		get
		{
			...
			IL2CPP.il2cpp_field_static_get_value(NativeFieldInfoPtr_Color, (void*)(&result));
			return result;
		}
		set
		{
			IL2CPP.il2cpp_field_static_set_value(NativeFieldInfoPtr_Color, (void*)(&color));
		}
	}
	...
	static Gingeritis()
	{
		...
		NativeFieldInfoPtr_Color = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Gingeritis>.NativeClassPtr, "Color");
		NativeMethodInfoPtr_ApplyToNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Gingeritis>.NativeClassPtr, 100685401);
		NativeMethodInfoPtr_ApplyToPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Gingeritis>.NativeClassPtr, 100685402);
		NativeMethodInfoPtr_ClearFromNPC_Public_Virtual_Void_NPC_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Gingeritis>.NativeClassPtr, 100685403);
		NativeMethodInfoPtr_ClearFromPlayer_Public_Virtual_Void_Player_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Gingeritis>.NativeClassPtr, 100685404);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Gingeritis>.NativeClassPtr, 100685405);
	}
	...
	public unsafe Gingeritis()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<Gingeritis>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public Gingeritis(IntPtr pointer)
		: base(pointer)
	{
	}
}

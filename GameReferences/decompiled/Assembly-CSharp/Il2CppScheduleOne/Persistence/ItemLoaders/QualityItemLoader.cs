...
public class QualityItemLoader : ItemLoader
{
	...
	static QualityItemLoader()
	{
		...
		NativeMethodInfoPtr_get_ItemType_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QualityItemLoader>.NativeClassPtr, 100669510);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QualityItemLoader>.NativeClassPtr, 100669511);
		NativeMethodInfoPtr_LoadItem_Public_Virtual_ItemInstance_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QualityItemLoader>.NativeClassPtr, 100669512);
	}
	...
	public unsafe QualityItemLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<QualityItemLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public QualityItemLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

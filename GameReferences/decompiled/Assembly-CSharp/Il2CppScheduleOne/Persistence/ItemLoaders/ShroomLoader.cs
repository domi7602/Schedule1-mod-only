...
public class ShroomLoader : ItemLoader
{
	...
	static ShroomLoader()
	{
		...
		NativeMethodInfoPtr_get_ItemType_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShroomLoader>.NativeClassPtr, 100669513);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShroomLoader>.NativeClassPtr, 100669514);
		NativeMethodInfoPtr_LoadItem_Public_Virtual_ItemInstance_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ShroomLoader>.NativeClassPtr, 100669515);
	}
	...
	public unsafe ShroomLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ShroomLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public ShroomLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

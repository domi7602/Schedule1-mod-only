...
public class CashLoader : ItemLoader
{
	...
	static CashLoader()
	{
		...
		NativeMethodInfoPtr_get_ItemType_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CashLoader>.NativeClassPtr, 100669488);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CashLoader>.NativeClassPtr, 100669489);
		NativeMethodInfoPtr_LoadItem_Public_Virtual_ItemInstance_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CashLoader>.NativeClassPtr, 100669490);
	}
	...
	public unsafe CashLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CashLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public CashLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

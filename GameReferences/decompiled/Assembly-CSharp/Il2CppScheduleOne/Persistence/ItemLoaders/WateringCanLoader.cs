...
public class WateringCanLoader : ItemLoader
{
	...
	static WateringCanLoader()
	{
		...
		NativeMethodInfoPtr_get_ItemType_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WateringCanLoader>.NativeClassPtr, 100669519);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WateringCanLoader>.NativeClassPtr, 100669520);
		NativeMethodInfoPtr_LoadItem_Public_Virtual_ItemInstance_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WateringCanLoader>.NativeClassPtr, 100669521);
	}
	...
	public unsafe WateringCanLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<WateringCanLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public WateringCanLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

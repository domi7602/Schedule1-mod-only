...
public class ClothingLoader : ItemLoader
{
	...
	static ClothingLoader()
	{
		...
		NativeMethodInfoPtr_get_ItemType_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ClothingLoader>.NativeClassPtr, 100669491);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ClothingLoader>.NativeClassPtr, 100669492);
		NativeMethodInfoPtr_LoadItem_Public_Virtual_ItemInstance_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ClothingLoader>.NativeClassPtr, 100669493);
	}
	...
	public unsafe ClothingLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ClothingLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public ClothingLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

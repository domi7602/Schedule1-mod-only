...
public class CocaineLoader : ItemLoader
{
	...
	static CocaineLoader()
	{
		...
		NativeMethodInfoPtr_get_ItemType_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CocaineLoader>.NativeClassPtr, 100669494);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CocaineLoader>.NativeClassPtr, 100669495);
		NativeMethodInfoPtr_LoadItem_Public_Virtual_ItemInstance_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CocaineLoader>.NativeClassPtr, 100669496);
	}
	...
	public unsafe CocaineLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CocaineLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public CocaineLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

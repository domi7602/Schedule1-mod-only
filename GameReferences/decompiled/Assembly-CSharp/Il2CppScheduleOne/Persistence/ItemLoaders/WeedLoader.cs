...
public class WeedLoader : ItemLoader
{
	...
	static WeedLoader()
	{
		...
		NativeMethodInfoPtr_get_ItemType_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WeedLoader>.NativeClassPtr, 100669522);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WeedLoader>.NativeClassPtr, 100669523);
		NativeMethodInfoPtr_LoadItem_Public_Virtual_ItemInstance_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WeedLoader>.NativeClassPtr, 100669524);
	}
	...
	public unsafe WeedLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<WeedLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public WeedLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

...
public class TimeLoader : Loader
{
	...
	static TimeLoader()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TimeLoader>.NativeClassPtr, 100669077);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TimeLoader>.NativeClassPtr, 100669078);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe TimeLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<TimeLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public TimeLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

...
public class RankLoader : Loader
{
	...
	static RankLoader()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RankLoader>.NativeClassPtr, 100669061);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RankLoader>.NativeClassPtr, 100669062);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe RankLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<RankLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public RankLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

...
public class VehicleLoader : Loader
{
	...
	static VehicleLoader()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VehicleLoader>.NativeClassPtr, 100669083);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VehicleLoader>.NativeClassPtr, 100669084);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe VehicleLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<VehicleLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public VehicleLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

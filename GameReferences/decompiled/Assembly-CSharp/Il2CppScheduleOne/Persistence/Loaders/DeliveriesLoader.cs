...
public class DeliveriesLoader : Loader
{
	...
	static DeliveriesLoader()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DeliveriesLoader>.NativeClassPtr, 100668998);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DeliveriesLoader>.NativeClassPtr, 100668999);
		NativeMethodInfoPtr_LoadVehicle_Public_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DeliveriesLoader>.NativeClassPtr, 100669000);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe DeliveriesLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<DeliveriesLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public unsafe void LoadVehicle(string vehiclePath)
	{
		...
		*ptr = IL2CPP.ManagedStringToIl2Cpp(vehiclePath);
		Unsafe.SkipInit(out IntPtr intPtr2);
		IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr_LoadVehicle_Public_Void_String_0, IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase)(object)this), (void**)ptr, ref intPtr2);
		Il2CppException.RaiseExceptionIfNecessary(intPtr2);
	}

	public DeliveriesLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

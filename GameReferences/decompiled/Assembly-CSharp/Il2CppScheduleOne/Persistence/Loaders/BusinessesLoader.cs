...
public class BusinessesLoader : Loader
{
	...
	static BusinessesLoader()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BusinessesLoader>.NativeClassPtr, 100668990);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BusinessesLoader>.NativeClassPtr, 100668991);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe BusinessesLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<BusinessesLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public BusinessesLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

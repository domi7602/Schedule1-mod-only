...
public class GameDataLoader : Loader
{
	...
	static GameDataLoader()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GameDataLoader>.NativeClassPtr, 100669006);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GameDataLoader>.NativeClassPtr, 100669007);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe GameDataLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<GameDataLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public GameDataLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

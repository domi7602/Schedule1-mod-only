...
public class StorageLoader : Loader
{
	...
	static StorageLoader()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<StorageLoader>.NativeClassPtr, 100669075);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<StorageLoader>.NativeClassPtr, 100669076);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe StorageLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<StorageLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public StorageLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

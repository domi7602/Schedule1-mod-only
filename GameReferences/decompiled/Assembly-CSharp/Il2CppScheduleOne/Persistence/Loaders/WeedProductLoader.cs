...
public class WeedProductLoader : Loader
{
	...
	static WeedProductLoader()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WeedProductLoader>.NativeClassPtr, 100669087);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<WeedProductLoader>.NativeClassPtr, 100669088);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe WeedProductLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<WeedProductLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public WeedProductLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

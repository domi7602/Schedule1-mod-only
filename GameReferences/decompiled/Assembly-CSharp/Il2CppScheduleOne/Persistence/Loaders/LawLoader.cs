...
public class LawLoader : Loader
{
	...
	static LawLoader()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LawLoader>.NativeClassPtr, 100669014);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LawLoader>.NativeClassPtr, 100669015);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe LawLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<LawLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public LawLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

...
public class VehiclesLoader : Loader
{
	...
	static VehiclesLoader()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VehiclesLoader>.NativeClassPtr, 100669085);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VehiclesLoader>.NativeClassPtr, 100669086);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe VehiclesLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<VehiclesLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public VehiclesLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

...
public class PlayerLoader : Loader
{
	...
	static PlayerLoader()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PlayerLoader>.NativeClassPtr, 100669032);
		NativeMethodInfoPtr_Load_Public_Virtual_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PlayerLoader>.NativeClassPtr, 100669033);
	}

	[CallerCount(2575)]
	[CachedScanResults(RefRangeStart = 370, RefRangeEnd = 2945, XrefRangeStart = 370, XrefRangeEnd = 2945, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe PlayerLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PlayerLoader>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public PlayerLoader(IntPtr pointer)
		: base(pointer)
	{
	}
}

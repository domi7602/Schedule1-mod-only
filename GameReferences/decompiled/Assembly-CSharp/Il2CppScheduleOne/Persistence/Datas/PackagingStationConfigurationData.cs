...
public class PackagingStationConfigurationData : RenamableConfigurationData
{
	...
	static PackagingStationConfigurationData()
	{
		...
		NativeFieldInfoPtr_Destination = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PackagingStationConfigurationData>.NativeClassPtr, "Destination");
		NativeMethodInfoPtr__ctor_Public_Void_StringFieldData_ObjectFieldData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PackagingStationConfigurationData>.NativeClassPtr, 100669394);
	}
	...
	public unsafe PackagingStationConfigurationData(StringFieldData name, ObjectFieldData destination)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PackagingStationConfigurationData>.NativeClassPtr))
	{
	...
	public PackagingStationConfigurationData(IntPtr pointer)
		: base(pointer)
	{
	}
}

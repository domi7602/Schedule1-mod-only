...
public class BotanistData : EmployeeData
{
	...
	static BotanistData()
	{
		...
		NativeFieldInfoPtr_MoveItemData = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<BotanistData>.NativeClassPtr, "MoveItemData");
		NativeMethodInfoPtr__ctor_Public_Void_String_String_String_String_Boolean_Int32_Vector3_Quaternion_Guid_Boolean_MoveItemData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BotanistData>.NativeClassPtr, 100669410);
	}
	...
	public unsafe BotanistData(string id, string assignedProperty, string firstName, string lastName, bool male, int appearanceIndex, Vector3 position, Quaternion rotation, Il2CppSystem.Guid guid, bool paidForToday, MoveItemData moveItemData)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<BotanistData>.NativeClassPtr))
	{
	...
	public BotanistData(System.IntPtr pointer)
		: base(pointer)
	{
	}
}

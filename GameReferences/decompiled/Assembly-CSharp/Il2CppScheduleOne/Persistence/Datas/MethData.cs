...
public class MethData : ProductItemData
{
	...
	static MethData()
	{
		...
		NativeMethodInfoPtr__ctor_Public_Void_String_Int32_String_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MethData>.NativeClassPtr, 100669366);
	}
	...
	public unsafe MethData(string iD, int quantity, string quality, string packagingID)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<MethData>.NativeClassPtr))
	{
	...
	public MethData(IntPtr pointer)
		: base(pointer)
	{
	}
}

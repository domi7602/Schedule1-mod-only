...
public class SpawnStationConfigurationData : RenamableConfigurationData
{
	...
	static SpawnStationConfigurationData()
	{
		...
		NativeFieldInfoPtr_Destination = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SpawnStationConfigurationData>.NativeClassPtr, "Destination");
		NativeMethodInfoPtr__ctor_Public_Void_StringFieldData_ObjectFieldData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SpawnStationConfigurationData>.NativeClassPtr, 100669399);
	}
	...
	public unsafe SpawnStationConfigurationData(StringFieldData name, ObjectFieldData destination)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<SpawnStationConfigurationData>.NativeClassPtr))
	{
	...
	public SpawnStationConfigurationData(IntPtr pointer)
		: base(pointer)
	{
	}
}

...
public class EnumFlagAttribute : DTPropertyAttribute
{
	...
	{
		Il2CppClassPointerStore<EnumFlagAttribute>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp-firstpass.dll", "FluffyUnderware.DevTools", "EnumFlagAttribute");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<EnumFlagAttribute>.NativeClassPtr);
		NativeMethodInfoPtr__ctor_Public_Void_String_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EnumFlagAttribute>.NativeClassPtr, 100664174);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 0, XrefRangeEnd = 0, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe EnumFlagAttribute(string label = "", string tooltip = "")
	...
	public EnumFlagAttribute(IntPtr pointer)
		: base(pointer)
	{
	}
}

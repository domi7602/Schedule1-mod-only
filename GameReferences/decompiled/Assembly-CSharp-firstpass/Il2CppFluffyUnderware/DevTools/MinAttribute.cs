...
public class MinAttribute : DTPropertyAttribute
{
	...
	static MinAttribute()
	{
		Il2CppClassPointerStore<MinAttribute>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp-firstpass.dll", "FluffyUnderware.DevTools", "MinAttribute");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<MinAttribute>.NativeClassPtr);
		NativeFieldInfoPtr_MinValue = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MinAttribute>.NativeClassPtr, "MinValue");
		NativeFieldInfoPtr_MinFieldOrPropertyName = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MinAttribute>.NativeClassPtr, "MinFieldOrPropertyName");
		NativeMethodInfoPtr__ctor_Public_Void_Single_String_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MinAttribute>.NativeClassPtr, 100664164);
		NativeMethodInfoPtr__ctor_Public_Void_String_String_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MinAttribute>.NativeClassPtr, 100664165);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 32240, XrefRangeEnd = 32243, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe MinAttribute(float value, string label = "", string tooltip = "")
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 32243, XrefRangeEnd = 32247, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe MinAttribute(string fieldOrProperty, string label = "", string tooltip = "")
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<MinAttribute>.NativeClassPtr))
	{
		IntPtr* ptr = stackalloc IntPtr[3];

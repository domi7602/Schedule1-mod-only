...
public class CGShapeResourceLoader : Il2CppSystem.Object
{
	...
	static CGShapeResourceLoader()
	{
		Il2CppClassPointerStore<CGShapeResourceLoader>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp-firstpass.dll", "FluffyUnderware.Curvy.Generator", "CGShapeResourceLoader");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CGShapeResourceLoader>.NativeClassPtr);
		NativeMethodInfoPtr_InitializeOnLoad_Protected_Static_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CGShapeResourceLoader>.NativeClassPtr, 100666159);
		NativeMethodInfoPtr_Create_Public_Virtual_Final_New_Component_CGModule_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CGShapeResourceLoader>.NativeClassPtr, 100666160);
		NativeMethodInfoPtr_Destroy_Public_Virtual_Final_New_Void_CGModule_Component_String_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CGShapeResourceLoader>.NativeClassPtr, 100666161);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CGShapeResourceLoader>.NativeClassPtr, 100666162);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 51000, XrefRangeEnd = 51010, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 51010, XrefRangeEnd = 51023, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 51023, XrefRangeEnd = 51029, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe CGShapeResourceLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CGShapeResourceLoader>.NativeClassPtr))
	{
		System.IntPtr* ptr = null;
		Unsafe.SkipInit(out System.IntPtr intPtr2);
	...
	public CGShapeResourceLoader(System.IntPtr pointer)
		: base(pointer)
	{
	}
}

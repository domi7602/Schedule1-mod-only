...
public class CGSplineResourceLoader : Il2CppSystem.Object
{
	...
	static CGSplineResourceLoader()
	{
		Il2CppClassPointerStore<CGSplineResourceLoader>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp-firstpass.dll", "FluffyUnderware.Curvy.Generator", "CGSplineResourceLoader");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CGSplineResourceLoader>.NativeClassPtr);
		NativeMethodInfoPtr_InitializeOnLoad_Protected_Static_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CGSplineResourceLoader>.NativeClassPtr, 100666163);
		NativeMethodInfoPtr_Create_Public_Virtual_Final_New_Component_CGModule_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CGSplineResourceLoader>.NativeClassPtr, 100666164);
		NativeMethodInfoPtr_Destroy_Public_Virtual_Final_New_Void_CGModule_Component_String_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CGSplineResourceLoader>.NativeClassPtr, 100666165);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CGSplineResourceLoader>.NativeClassPtr, 100666166);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 51029, XrefRangeEnd = 51039, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 51039, XrefRangeEnd = 51049, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 51049, XrefRangeEnd = 51055, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe CGSplineResourceLoader()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CGSplineResourceLoader>.NativeClassPtr))
	{
		System.IntPtr* ptr = null;
		Unsafe.SkipInit(out System.IntPtr intPtr2);
	...
	public CGSplineResourceLoader(System.IntPtr pointer)
		: base(pointer)
	{
	}
}

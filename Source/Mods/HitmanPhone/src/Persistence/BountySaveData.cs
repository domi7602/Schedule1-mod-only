...
public class BountySaveData
{
    ...
    /// <summary>
    /// Heat-related transient state (grace timestamps, escalation flags).
    /// Phase G uses this to hold the player's pursuit at Investigating during
    /// the 60s post-kill grace window.
    /// </summary>
